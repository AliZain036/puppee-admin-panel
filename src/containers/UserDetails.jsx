                            ...
                            <div className="form-group row">
                              ...
                              <div className="col-md-6 col-sm-6">
                                <input
                                  ...
                                  name="name"
                                  className="form-control"
                                  value="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec non nisi pellentesque, condimentum arcu at, aliquet neque. Ut id sollicitudin dolor, non lacinia magna."
                                  onChange={this.handleInputChange}
                                />
                              </div>
                            </div>
                            ...
                            <div className="form-group row">
                              ...
                              <div className="col-md-6 col-sm-6">
                                <input
                                  ...
                                  name="name"
                                  className="form-control"
                                  value="Century 21 Energy Realty"
                                  onChange={this.handleInputChange}
                                />
                              </div>
                            </div>
