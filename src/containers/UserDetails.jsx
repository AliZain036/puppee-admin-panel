...
export default class Posts extends React.Component {
  ...
  async componentWillMount() {
    ...
    this.fetchUserDetail(match.params.userId);
          ...
          <div className="row justify-content-between">
            <div className="float-left col-sm-6 space-1">
              ...
              <button
                ...
                onClick={() => this.tabChangeHandler("Referals")}
              >
                Referals
              </button>
              ...
              <div className="col-12">
                ...
                <div className="row space-1 justify-content-md-center">
                  <div className="col-md-6 justify-content-md-center">
                    ...
                    <div>
                      <h5 style={{ display: "inline-block" }}>Office:</h5>
                      <h6 style={{ display: "inline-block", float: "right" }}>
                        {" "}
                    ...
                    <div>
                      <h5 style={{ display: "inline-block" }}>Languages:</h5>
                      <h6 style={{ display: "inline-block", float: "right" }}>
                        {" "}
                    ...
                    <div>
                      ...
                      >
                        {" "}
                        Street 123, Area ABC , BC
                        <br />
                        Latitude: 35.4 , Longitude: 68.8
                      </h6>
                    </div>
                  </div>
                </div>
              ...
              <table className="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>John Smith</td>
                    <td>ABC Real Estate</td>
                    <td>Century 21 Energy Realty</td>
                    <td>123 Street, 123456, Burnaby, BC</td>
                    {/* <td>
                      <Link
                        to={{
