...
export default class UserDetails extends React.Component {
  ...
  async getUserFollowings() {
    ...
    let result = await getDataById("show-following", reqBody);
    if (result.data && result.data.length > 0) {
      this.setState({ followings: result.data });
    }
  }
  ...
  async getUserFollowers() {
    ...
    let result = await getDataById("show-followers", reqBody);
    if (result.data && result.data.length > 0) {
      this.setState({ followers: result.data });
    }
  }

  async togglePostBlockStatus(post) {
    let reqBody = {
      post_id: post.id,
    };
    let result = {};
    if (post.status && post.status === "active") {
      result = await addUpdateData("block-post", reqBody);
    } else if (post.status && post.status === "block") {
      result = await addUpdateData("unblock-post", reqBody);
    }
    if (result) {
      this.getUserPosts(this.props.match.params.userId);
      SwalAutoHide.fire({
  ...
  async getBlockedUsers() {
    ...
    if (result) {
      this.setState({ blocked: result.data[0].blocked_users });
    }
  }
    ...
    return (
      <div className="row animated fadeIn">
        <div className="col-12">
          <div>
            <h3>
              {user && user.first_name + " " + user.last_name + "'s "} Details
            </h3>
          </div>
          ...
          <div className="table-responsive">
            {this.state.status === "Details" && this.state.user != null && (
              <div className="row animated fadeIn">
                <div className="col-12">
                  <div className="row">
                            ...
                            <div className="form-group row">
                              ...
                              <div className="col-md-6 col-sm-6">
                                <input
                                  ...
                                  name="name"
                                  className="form-control"
                                  value={this.arrToStr(user.languages) || ""}
                                  readOnly
                                />
                              </div>
                            </div>
                    ...
                    this.state.userPosts.map((post, index) => {
                      return (
                        <tr key={post.id}>
                          ...
                          <td>
                            <button
                              onClick={() => this.togglePostBlockStatus(post)}
                          ...
                          <tr key={follower.id}>
                            ...
                            <td>
                              <img
                                ...
                                src={
                                  follower.profile &&
                                  follower.profile.profile_image
                                    ? follower.profile.profile_image
                            ...
                            <td>
                              {follower.profile && follower.profile.profession}
                            </td>
                            <td>
                              {follower.profile &&
                                follower.profile.company_name}
                            </td>
                          ...
                          <tr key={following.id}>
                            ...
                            <td>
                              <img
                                ...
                                src={
                                  following.profile &&
                                  following.profile.profile_image
                                    ? following.profile.profile_image
                                    : "data:image/png;base64,"
                                }
                              />
                            ...
                            <td>
                              {following.profile &&
                                following.profile.profession}
                            </td>
                            <td>
                              {following.profile &&
                                following.profile.company_name}
                            </td>
